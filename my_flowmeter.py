...
class Flowmeter:
    ...
    def build_feature_from_packet_list(self, packet_list):
    ...
    def build_feature_from_flow(self, flow):
    ...
    def build_feature_dataframe(self):        
        ...
        self._frames = pool.map(self.build_feature_from_flow, self._sessions)
